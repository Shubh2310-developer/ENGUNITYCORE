...
export const Breadcrumbs = () => {
  ...
  return (
    <div className="h-8 flex items-center px-4 bg-[#F8FAFC] border-b border-[#CBD5E1] overflow-hidden select-none">
        ...
        {breadcrumbs.map((item, index) => (
          <React.Fragment key={item.id}>
            ...
            >
              ...
              <span className={index === breadcrumbs.length - 1 ? 'text-[#0F172A] font-bold' : ''}>{item.name}</span>
            </div>
