...
{It is my pleasure to certify that worked under my supervision for the
B. Tech. 
    \begin{table}[htbp]
\centering
...
\end{tabular}
\end{table}
dissertation/ Project report entitled {\mytitle}}{\textbf{\ }}and his/her work is of the level of requirement set up for the dissertation/Project Report in {\branch}  by Shah \& Anchor Kutchhi Engineering College, Mumbai.}
